...
Public Class UserGroup
    ...
    Public ReadOnly Property OrganizationId As Guid Implements IUserGroup.OrganizationId
        Get
            Return m_innerGroup.OrganizationId
        End Get
    End Property
    ...
    Public Sub Create(transactionHandler As ITransactionHandler) Implements ISavable.Create
        ...
        Using scope As ILifetimeScope = m_container.BeginLifetimeScope
            ...
            m_userGroupData.OrganizationId = m_innerGroup.OrganizationId
            creator = scope.ResolveKeyed(Of DataTier.Utilities.IDataCreator)("UserGroupDataSaver",
    ...
    Public Sub Update(transactionHandler As ITransactionHandler) Implements ISavable.Update
        ...
        Using scope As ILifetimeScope = m_container.BeginLifetimeScope
            updater = scope.ResolveKeyed(Of DataTier.Utilities.IDataUpdater)("UserGroupDataSaver",
                New TypedParameter(GetType(AbyssalDataProcessor.DataTier.Utilities.ITransactionHandler), New TransactionHandler(transactionHandler)),
                New TypedParameter(GetType(UserGroupData), m_userGroupData)
            )
            updater.Update()
