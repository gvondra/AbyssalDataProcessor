...
Public Class TransformIndex
    ...
    Public Shared ReadOnly Property ResourceManager() As Global.System.Resources.ResourceManager
        Get
            If Object.ReferenceEquals(resourceMan, Nothing) Then
                Dim temp As Global.System.Resources.ResourceManager = New Global.System.Resources.ResourceManager("AbyssalDataProcessor.Core.Form.Style.Index", GetAssembly)
                resourceMan = temp
            End If
            Return resourceMan
        End Get
    ...
    Private Shared Function GetAssembly() As Assembly
        Return Assembly.Load("AbyssalDataProcessor.Core.Form.Style")
    End Function
