    ...
    Public Sub Create(ByVal providerFactory As IDbProviderFactory)
        ...
        If m_formData.DataStateManager.GetState(m_formData) = IDataStateManager(Of UserData).enumState.New Then
            ...
            Using command As IDbCommand = m_transactionHandler.Connection.CreateCommand
                ...
                command.CommandText = "clnt.iForm"
                ...
                AddParameter(providerFactory, command.Parameters, "organizationId", DbType.Guid, GetParameterValue(m_formData.OrganizationId))
                ...
                AddParameter(providerFactory, command.Parameters, "content", DbType.String, GetParameterValue(m_formData.Content))
