...
Public Class UserGroupDataFactoryTest
    ...
    Public Sub GetByUserIdTest()
        ...
        factory.GetByUserId(settings.Object, providerFactory.Object, Guid.Empty, Guid.Empty)

        command.VerifySet(Sub(c As IDbCommand) c.CommandText = "clnt.sUserGroupByUserId", Times.Once)
