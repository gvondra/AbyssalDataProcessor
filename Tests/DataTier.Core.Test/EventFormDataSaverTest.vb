<TestClass()>
Public Class EventFormDataSaverTest

    <TestMethod()>
    Public Sub CreateTest()
        Dim transactionHandler As New Mock(Of ITransactionHandler)()
        Dim data As New EventFormData()
        Dim saver As New EventFormDataSaver(transactionHandler.Object, data)
        ...
        command.VerifySet(Sub(c As IDbCommand) c.CommandText = "adp.iEventForm", Times.AtLeastOnce)
    End Sub
