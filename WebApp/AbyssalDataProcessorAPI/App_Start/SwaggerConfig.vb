    ...
    Public Shared Sub Register(ByVal config As HttpConfiguration)
        ...
        Sub(c As SwaggerDocsConfig)
            ...
            With oauthSchemeBuilder
                ...
                .Flow("implicit")
                .AuthorizationUrl("https://abyssaldataprocessor-dvlp.auth0.com/authorize")
                .TokenUrl("https://abyssaldataprocessor-dvlp.auth0.com/oauth/token")
            End With
        End Sub) _
        .EnableSwaggerUi(
        Sub(c As SwaggerUiConfig)
            c.EnableOAuth2Support(
                        ...
                        realm:="abyssaldataprocessor-dvlp.auth0.com",
                        appName:="http://localhost/abyssaldataprocessor/api",
