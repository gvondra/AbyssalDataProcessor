...
export class WebMetricsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private webMetricsService: WebMetricsService) { }
  ...
  ngOnInit() {    
    ...
    .switchMap((params: ParamMap) => {
      ...
      if (params['until'] && Date.parse(params['until'])) {
        ...
        return this.webMetricsService.getWebMetricsByMaxCreateTimestamp(d, this.Page);
      }
      else {
        let d: Date = new Date();
